...
import com.example.namo.Constant.Companion.CHANNEL_ID
import com.example.namo.Constant.Companion.NOTIFICATION_ID

class NotificationReceiver : BroadcastReceiver() { //푸시 알림
...
//    val CHANNEL_ID = "notification_channel"
    ...
    private fun deliverNotification(context: Context){
        ...
        val builder = NotificationCompat.Builder(context, CHANNEL_ID)
            .setSmallIcon(R.drawable.app_logo_namo) // 아이콘
            .setContentTitle("나모") // 제목
            .setContentText("자세한 알람 내용. 대충 일정 이름") // 내용
