...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.example.namo.Bottom.Home.Record.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.example.namo.Bottom.Home.Record.GlideOptions().apply(toSet));
    }
  }
}
